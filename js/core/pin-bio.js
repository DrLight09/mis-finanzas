...
// reemplaza los dos reintentos manuales con setInterval que tenía este
// archivo (registro de Events('pin',...) y el hook de refresh(), más
// abajo). Se usa `import` en vez de asumir un global porque este archivo
