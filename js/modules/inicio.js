...
function renderProyeccion(){
  ...
  const fmt = x=>Math.round(x).toLocaleString('es-CO',{style:'currency',currency:'COP',maximumFractionDigits:0});
  const patrimonio = window.calcPatrimonioTotal ? window.calcPatrimonioTotal() : 0;
  ...
  (function(){
    const fmt2 = x=>Math.round(x).toLocaleString('es-CO',{style:'currency',currency:'COP',maximumFractionDigits:0});
